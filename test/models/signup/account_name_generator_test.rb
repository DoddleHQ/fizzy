...
class Signup::AccountNameGeneratorTest < ActiveSupport::TestCase
  ...
  test "generate" do
    ...
    assert_equal "Newart's oCode", account_name, "The 1st account doesn't have 1st in the name"
    ...
    account_name = @generator.generate
    assert_equal "Newart's 2nd oCode", account_name
    ...
    account_name = @generator.generate
    assert_equal "Newart's 3rd oCode", account_name
    ...
    account_name = @generator.generate
    assert_equal "Newart's 4th oCode", account_name
    ...
    account_name = @generator.generate
    assert_equal "Newart's 5th oCode", account_name
  end

  test "generate continues from the previous highest index" do
    account = Account.create!(external_account_id: "12th", name: "Newart's 12th oCode")
    Current.without_account do
    ...
    account_name = @generator.generate
    assert_equal "Newart's 13th oCode", account_name
  end
end
